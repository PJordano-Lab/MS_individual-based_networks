...
null.metrics.long.selec <- null.metrics.long |> 
  ...
  filter(null_metric %in% c("connectance Patefield", "M Swap", "assortativity Swap",
                            "centralization.w Swap", "interaction.evenness Swap", "weighted.NODF Swap")) |> 
  mutate(metric2 = as.factor(recode(metric, 
                         "M" = "Modularity",
                         "assortativity" = "Assortativity",
                         "centralization.w" = "Centralization",
...
ggsave(here("figs/Fig_2_net_level_comparison.png"), width = 8, height = 5)
```
